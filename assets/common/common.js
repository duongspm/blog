...
function initCustomCursor() {
    ...
    if (document.body.classList.contains('admin-page') || window.innerWidth < 1024) {
    ...
    const interactiveElements = 'a, button, .blog-item, .magnetic-btn, .project-card';
...
function handleScroll() {
    ...
    if (btnTop) {
        winScroll > 400 ? btnTop.classList.add('show') : btnTop.classList.remove('show');
    }
...
function toggleTheme() {
    ...
    currentTheme === 'dark' ? html.removeAttribute('data-theme') : html.setAttribute('data-theme', 'dark');
}
